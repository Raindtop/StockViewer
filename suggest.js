 ...
 * @version 1.0.2
 */
function loadJs(l, f, e) {
    var b = {}.toString.call(l) === "[object Array]", a = document.getElementsByTagName("SCRIPT")[0], h = a.parentNode,
        d = 0, j = false, g = 3000, c = function (m) {
        ...
        _getRemoteData: function (callback) {
            ...
            if (window.TYPE && TYPE == "financeQQ") {
                utils.ajax(url, function (d) {
                    ...
                    var data = temp.filter(obj => obj[4] == "GP-A");
